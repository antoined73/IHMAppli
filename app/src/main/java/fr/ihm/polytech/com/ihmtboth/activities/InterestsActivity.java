...
public class InterestsActivity extends ToolBarActivity {
    ...
    protected void selectFragment(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.action_done:
                new Saver(this).saveInterests(((CriteriaFragment)frag).getNewRequest());
                this.finish();
                break;
    ...
    public Fragment getInitialFragment() {
        return CriteriaFragment.newInstance(R.color.cardview_shadow_end_color,true);
    }
